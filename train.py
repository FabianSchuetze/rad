...
def evaluate(env, agent, video, num_episodes, L, step, args):
    ...
    def run_eval_loop(sample_stochastically=True):
        ...
        filename = args.work_dir + '/' + args.domain_name + '--' + args.task_name + \
            '-' + args.data_augs + '--s' + str(args.seed) + '--eval_scores.npy'
...
def main():
    ...
    exp_name = env_name + '-' + ts + '-im' + str(args.image_size) + '-b' + str(
        args.batch_size) + '-s' + str(args.seed) + '-' + args.encoder_type
